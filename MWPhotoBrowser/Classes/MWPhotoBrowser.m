...
- (void)viewDidLoad {
    ...
    // Toolbar
    _toolbar = [[UIToolbar alloc] initWithFrame:[self frameForToolbarAtOrientation:![self isOrientationPortrait]]];
...
- (CGRect)frameForToolbarAtOrientation:(BOOL)isLandscape {
    CGFloat height = 44;
